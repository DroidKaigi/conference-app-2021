...
import io.github.droidkaigi.confsched2021.news.ui.news.NewsViewModel.Event.OnChangeFavoriteFilter
import io.github.droidkaigi.confsched2021.news.ui.news.NewsViewModel.Event.OpenDetail
import io.github.droidkaigi.confsched2021.news.ui.news.NewsViewModel.Event.OnToggleFavorite
...
class NewsViewModelTest(val name: String, val newsViewModelFactory: () -> NewsViewModel) {
    ...
    fun favorite_Add() = coroutineTestRule.testDispatcher.runBlockingTest {
        ...
        newsViewModel.event(OnToggleFavorite(firstContent.newsContents[0]))
    ...
    fun favorite_Remove() = coroutineTestRule.testDispatcher.runBlockingTest {
        ...
        newsViewModel.event(OnToggleFavorite(news = firstContent.newsContents[0]))
        newsViewModel.event(OnToggleFavorite(news = firstContent.newsContents[0]))
    ...
    fun favorite_Filter() = coroutineTestRule.testDispatcher.runBlockingTest {
        ...
        newsViewModel.event(OnToggleFavorite(news = favoriteContents))
        newsViewModel.event(OnChangeFavoriteFilter(Filters(filterFavorite = true)))
