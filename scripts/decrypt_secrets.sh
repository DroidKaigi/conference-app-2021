...
gpg --quiet --batch --yes --decrypt --passphrase="$SECRET_PASSPHRASE" \
  --output "ios/DroidKaigi Feeder/DroidKaigi Feeder/GoogleService-Info-Production-Release.plist" "ios/DroidKaigi Feeder/DroidKaigi Feeder/GoogleService-Info-Production-Release.plist.gpg"
gpg --quiet --batch --yes --decrypt --passphrase="$SECRET_PASSPHRASE" \
